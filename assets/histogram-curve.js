...
/***/ function(module, exports, __webpack_require__) {
	...
	var binNum = 20,
	    ...
	    rangeMax = 210;
	//直方图布局生成器
	var histogram = d3.layout.histogram().range([rangeMin, rangeMax]).bins(binNum).frequency(true);
	//生成直方图布局数据
	...
	var gLine = svg.append('g').attr('transform', 'translate(' + padding.left + ', ' + -padding.bottom + ')').style('opacity', 0.5);

	gLine.append('path').classed('linePath', true).attr('d', lineGenerator(histogramData));
