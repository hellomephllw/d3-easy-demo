...
/***/ function(module, exports, __webpack_require__) {
	...
	//图形2
	var rectEle = svg.append('rect').attr('x', 150).attr('y', 70).attr('width', 70).attr('height', 60).style('fill', 'black');
	...
	//创建刷子
	var brush = d3.svg.brush().x(xScale).y(yScale).extent([[0, 0], [100, 100]]).on('brush', brushed).on('brushstart', brushStart).on('brushend', brushEnd);

	brushEle = svg.append('g').call(brush).selectAll('rect').style({ 'fill-opacity': .3, 'opacity': 0 });
