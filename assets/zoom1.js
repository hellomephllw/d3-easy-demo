...
/***/ function(module, exports, __webpack_require__) {
	...
	var zoom = d3.behavior.zoom().scaleExtent([1, 10]).on('zoom', function (d) {
	...
	var g = svgEleD3.append('g').call(zoom);

	g.selectAll('circle').data(circles).enter().append('circle').attr('cx', function (d) {
	    return d.cx;
	}).attr('cy', function (d) {
	    return d.cy;
	}).attr('r', function (d) {
